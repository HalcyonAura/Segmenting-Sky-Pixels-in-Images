...
function ds_info=my_gen_ds_info_skyfinder(ds_config)



ds_dir=fullfile('../datasets', 'SkyFinder');
...
ds_info.class_info=gen_class_info_skyfinder();

ds_info.ds_name='SkyFinder';
